...
@Component({
  selector: 'app-editpassive',
  templateUrl: './editpassive.component.html',
  styleUrls: ['./editpassive.component.scss']
})
export class EditpassiveComponent implements OnInit {
...
upgrade(){
  this.route.navigateByUrl(`/home/me/my-advertising/passive-ads`)
}
toggleonline(){
