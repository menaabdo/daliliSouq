...
@Component({
  selector: 'app-edit-store-passive',
  templateUrl: './edit-store-passive.component.html',
  styleUrls: ['./edit-store-passive.component.scss']
})
export class EditStorePassiveComponent implements OnInit {
...
upgrade(){
  ...
  this.route.navigateByUrl(`/home/me/store/${this.storessserve.product_data.store_id}/myproducts/${this.storessserve.product_data.store_id}/passive-ads/${this.storessserve.product_data.store_id}`)
}
toggleonline(){
