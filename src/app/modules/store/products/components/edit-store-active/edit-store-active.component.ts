...
@Component({
  selector: 'app-edit-store-active',
  templateUrl: './edit-store-active.component.html',
  styleUrls: ['./edit-store-active.component.scss']
})
export class EditStoreActiveComponent implements OnInit {
...
// }
 ...
 //this.route.navigateByUrl(`/home/me/profile/my-profile/edit-properities`)
   ...
   changepro(){
    ...
    this.route.navigateByUrl(`/home/me/store/${this.storessserve.product_data.store_id}/myproducts/${this.storessserve.product_data.store_id}/edit-properities`)
...
upgrade(){
  ...
  this.route.navigateByUrl(`/home/me/store/${this.storessserve.product_data.store_id}/myproducts/${this.storessserve.product_data.store_id}/active-ads/${this.storessserve.product_data.store_id}`)
}
toggleonline(){
...
localStorage.setItem('imgs',JSON.stringify(this.imageSrc))
 ...
 if(this.response2.Response.region&&this.response2.Response.region.name)
